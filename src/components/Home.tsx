        ...
        <section className="about">
          <div className="container intro">
            ...
            <p className="w-50">
              ...
              latest and greatest in technology gear and gadgets. We offer a
              wide selection of products from the top brands in the industry,
              and are committed to providing our customers with the best
